    ...
    <table border="0" width="1000" height="21" align="center">
        <tr>
            <td valign="top">
                ...
                <p><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><i>pdbid: <%=pdbid%> | 3D distance: <%=sdis%> | 1D distance: <%=ld%>  </I></FONT></p>
                <form>
                    <div style="width:400px; height:400px; background-color:#008080; resize:both; overflow:hidden; padding:6px; float:left;">
                        <script type="text/javascript">
                            jmolInitialize("../jmol");
                            jmolApplet("100%", "load ../jmol/models/<%=pdbid%>.pdb; set antialiasdisplay true; background white; wireframe off; spacefill off; cartoons; color structure; select <%=pdbcon1%>:<%=chain1%>; spacefill; color [138,255,0]; select <%=pdbcon2%>:<%=chain2%>; spacefill; color [138,255,0];");
                        </script>
                    </div>
                </form>
                ...
                <form>
                    <script type="text/javascript">
                        ...
                        jmolRadioGroup(
                            [
                            ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; spacefill off", "off"],
                            ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; spacefill 20%", "20%"],
                            ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; spacefill 100%","100%","checked"]
                            ], "<font size =2 >"
                       );
                       ...
                       jmolRadioGroup(
                               [
                               ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; spacefill; color[138,255,0]", "default"],
                               ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; wireframe 10; spacefill; color cpk", "wireframe"],
                               ["select <%=pdbcon1%>:<%=chain1%>, <%=pdbcon2%>:<%=chain2%>; dots", "dots"]
                               ]
                       );
                       ...
                       jmolHtml("    ");
                       jmolCheckbox("select <%=pdbcon2%>:<%=chain2%>.CA; font label 20; color label black; set labelfront; label <%=aac2%>;", "label off", "<%=aac2%>");
                       ...
                       jmolBr();
                       jmolHtml("chain <%=chain2%>: ");
                        jmolMenu([
                         ["select :<%=chain2%>; color white", "white"],
                         ["select :<%=chain2%>; color skyblue", "skyblue", "selected"],
            ...
            <td align="left" valign="top">
                ...
                <table width="600" border="0">
                    <tr>
                        <td colspan=6><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="3"><i><B>Mutation 1</B></I></FONT></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan=6><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="3"><i><B>Mutation 2</B></I></FONT></td>
                    </tr>
                    <tr>
                        <td width=30><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=gene2%></td>
                        <td width=20><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=pdbcon2%></td>
                        <td width=20><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=aac2%></td>
                        <td width=20><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=type2%></td>
                        <td width=10><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=chain2%></td>
                        <td width=200><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="2"><%=domain2%></td>
                    </tr>
                    <tr> <td colspan = 6 > &nbsp; </td></tr>
                    <tr>
                        <td colspan=6><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="3"><i><B>Close to Mutation 1</B></I></FONT></td>
                    </tr>
                ...
                <% 
                    ...
                    <tr> <td colspan = 6 > &nbsp; </td></tr>
                    <tr>
                        <td colspan=6><FONT COLOR="#800000" face="Arial, Helvectica, sans-serif" size="3"><i><B>Close to Mutation 2</B></I></FONT></td>
                    </tr>
